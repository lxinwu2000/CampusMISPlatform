<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\phpStudy\WWW\wsjadmin/application/admin\view\productype\info.html";i:1509693010;s:59:"D:\phpStudy\WWW\wsjadmin/application/admin\view\layout.html";i:1509693351;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="light-blue dropdown-modal">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="<?php echo config('public.static'); ?>/ace1.4/assets/images/avatars/user.jpg" alt="头像" />
    ...
    <div class="row">
        <div class="col-xs-12">
             <form class="form-horizontal" role="form"  method="post"  >  
               <?php echo input('typeid')?'<input type="hidden" value="'.$info['typeid'].'" id="typeid" name="typeid">':''; ?>        
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">产品类型：</label>
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" value="<?php echo $info['name']; ?>" id="name" name="name"/>
                    </div>
                </div>    
                <div class="space-4"></div>
           
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">类型简介：</label>
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" id="info" name="info"  value="<?php echo $info['info']; ?>"/>
                    </div>
                </div>    
                <div class="space-4"></div>
                ...
                <div class="clearfix form-actions">
                    <div class="col-md-offset-3 col-md-9">
                        <a class="btn btn-info"  <?php echo input('typeid')?'onclick="pedit()"':'onclick="padd()"'; ?>>
  ...
  <script src="<?php echo config('public.tp5jump'); ?>/layer/jquery.min.js"></script>
  <script src="<?php echo config('public.tp5jump'); ?>/layer/layer.js"></script>
  <script src="<?php echo config('public.tp5jump'); ?>/my.js"></script>     
                </div>
            </div><!-- /.main-content -->
                ...
                <div class="footer-inner">
                    <div class="footer-content">
                        <span class="bigger-120">
                            <span class="blue bolder"><a href="https://github.com/duzhenxun/TP5Admin" target="_blank">wsjAdmin</a></span>
                             &copy; 2016-2018
                        </span>
