<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\phpStudy\WWW\wsjadmin/application/admin\view\admin\index.html";i:1509433357;s:59:"D:\phpStudy\WWW\wsjadmin/application/admin\view\layout.html";i:1516673473;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <table id="simple-table" class="table table-condensed table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if($vo['id'] == '1'): ?>超级管理员<?php else: ?><?php echo $vo['groups']; endif; ?></td>
                                <td class="hidden-480"><?php echo long2ip($vo['lastloginip']); ?></td>
                                <td><?php echo date('Y-m-d H:i:s',$vo['lastlogintime']); ?></td>

                                <td class="hidden-480">
                                    <span class="label label-sm label-warning"><?php echo $vo['realname']; ?></span>
                                </td>
