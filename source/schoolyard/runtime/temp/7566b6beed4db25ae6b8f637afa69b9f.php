<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\phpStudy\WWW\wsjadmin/application/admin\view\admin\info.html";i:1509341505;s:59:"D:\phpStudy\WWW\wsjadmin/application/admin\view\layout.html";i:1516673473;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo input('id')?'edit':'add'; ?>" method="post" name="myfrom" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" value="<?php echo (isset($info['username']) && ($info['username'] !== '')?$info['username']:''); ?>" name="username"/>
                    </div>
                </div>    
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="password" name="rpassword" placeholder="Password" class="col-xs-10 col-sm-5" />
                        <span class="help-inline col-xs-12 col-sm-7">
                            <span class="middle"></span>
                        </span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="email" value='<?php echo (isset($info['email']) && ($info['email'] !== '')?$info['email']:''); ?>'/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="mobile"  value='<?php echo (isset($info['mobile']) && ($info['mobile'] !== '')?$info['mobile']:''); ?>'/>
                    </div>
                </div>    
                <div class="space-4"></div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="realname"  value='<?php echo (isset($info['realname']) && ($info['realname'] !== '')?$info['realname']:''); ?>'/>
                    </div>
                </div>    
                <div class="space-4"></div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <?php echo checkbox($groups,$info['userGroups'],'name="groups[]"'); ?>
