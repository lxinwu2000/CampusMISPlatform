<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\phpStudy\WWW\wsjadmin/application/admin\view\admin\public_edit_info.html";i:1509257234;s:59:"D:\phpStudy\WWW\wsjadmin/application/admin\view\layout.html";i:1516673473;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="" method="post" name="myfrom" >
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                     <input type="text" name="username" placeholder="username" value='<?php echo $info['username']; ?>' class="col-xs-10 col-sm-5" disabled/>
