<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\phpStudy\WWW\wsjadmin/application/admin\view\menu\index.html";i:1515036633;s:59:"D:\phpStudy\WWW\wsjadmin/application/admin\view\layout.html";i:1516757720;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <table id="simple-table" class="table table-condensed table-bordered table-hover">
                        ...
                        <form action="" method="post" name="myform">
                            ...
                            <tr>
                                ...
                                <td><?php echo str_repeat("│        ",$vo['level']); if($vo['level'] == '0'): ?>
                                <span class="fa <?php echo $vo['icon']; ?>"></span> 
                                <b><?php echo $vo['name']; ?></b><?php else: ?>├─<?php echo $vo['name']; endif; ?>
                                </td>
