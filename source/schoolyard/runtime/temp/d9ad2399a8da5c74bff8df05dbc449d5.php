<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\phpStudy\WWW\tp5auth/application/admin\view\admin\public_edit_info.html";i:1509246735;s:58:"D:\phpStudy\WWW\tp5auth/application/admin\view\layout.html";i:1509250396;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="" method="post" name="myfrom" >
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <?php echo (isset($info['username']) && ($info['username'] !== '')?$info['username']:''); ?>
                    </div>
                </div>    
