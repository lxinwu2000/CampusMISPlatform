<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\wsjadmin/application/admin\view\log\index.html";i:1516679312;s:59:"D:\phpStudy\WWW\wsjadmin/application/admin\view\layout.html";i:1516757720;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div class="col-sm-6 pull-right">
        <span class="btn btn-sm btn-primary pull-right" onclick="pldel()">
            批量删除
                    ...
                    <table id="simple-table" class="table table-condensed table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $vo['c']; ?>/<?php echo $vo['a']; ?><?php echo $vo['querystring']; ?></td>
                                <td class="hidden-480"><a href="http://ip138.com/ips138.asp?ip=<?php echo long2ip($vo['ip']); ?>" target="_blank"><?php echo long2ip($vo['ip']); ?></a></td>
