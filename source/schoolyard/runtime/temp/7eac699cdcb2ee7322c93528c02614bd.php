<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\phpStudy\WWW\wsjadmin/application/admin\view\group\index.html";i:1509433381;s:59:"D:\phpStudy\WWW\wsjadmin/application/admin\view\layout.html";i:1516673473;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <table id="simple-table" class="table table-condensed  table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href='<?php echo url("admin/index","group_id=$vo[id]"); ?>' target="_blank"><?php echo $vo['name']; ?></a></td>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs btn-group">
                                        ...
                                        <a href='<?php echo url("rule","gid=$vo[id]"); ?>' 
                                           <span class="btn btn-xs btn-purple">
