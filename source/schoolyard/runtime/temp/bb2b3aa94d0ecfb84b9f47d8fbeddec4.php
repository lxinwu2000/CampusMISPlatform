<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\phpStudy\WWW\wsjadmin/application/admin\view\productype\index.html";i:1509693191;s:59:"D:\phpStudy\WWW\wsjadmin/application/admin\view\layout.html";i:1509693351;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="col-xs-12">
              <table id="simple-table" class="table table-condensed table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="del<?php echo $vo['typeid']; ?>">
                                <td class="center">
                                    <label class="pos-rel">
                                        <input type="checkbox" class="ace" />
                                        <span class="lbl"></span>
                                ...
                                <div class="hidden-sm hidden-xs btn-group">
                                        ...
                                        <a href='<?php echo url("info","typeid=$vo[typeid]"); ?>'> 
                                           <span class="btn btn-xs btn-info">
                                                <i class="ace-icon fa fa-pencil bigger-120"></i>
                                            </span>
                                        </a>                               
                                        <a href='javascript:void(0)' onclick='return del("<?php echo $vo['typeid']; ?>")' >
