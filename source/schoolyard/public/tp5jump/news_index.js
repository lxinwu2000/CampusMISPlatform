...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
    ...
    ,cols: [[
      ...
      ,{field:'title', width:85, title: '标题',align:'center'}
      ,{field:'summary', width:85, title: '摘要',align:'center'}
      ,{field:'keywords', width:200, title: '关键词',align:'center'}
      ,{field:'source', width:180, title: '来源',align:'center'}
      ,{field:'contents', width:180, title: '内容',align:'center'}    
