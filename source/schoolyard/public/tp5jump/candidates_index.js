...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
     elem: '#positionstable'
    ,url:Root+'admin/Candidates/json'
    ,height: 'full-150'   
    ,cellMinWidth: 80 
    ...
    ,cols: [[
      ...
      ,{field:'resume', width:150, title: '简历描述',align:'center'}
      ,{field:'filepath', width:150, title: '附件',align:'center'}
  ...
  table.on('tool(Idtableb)', function(obj){
	   ...
	   if(obj.event === 'del'){
	      layer.confirm('真的删除这条数据么', function(index){	    		    	
	    	 Ajaxalls(rid,null,2,'admin/Candidates/delete');
//	    	 obj.del();
         ...
         ,getCheckid:function(){
        	 ...
        	 if(checkedid.length=='0'){
        		 ...
        		 layer.confirm('真的删除这些数据吗', function(index){       		    	
        		    	 $.ajax({
        		 			url : Root+"admin/Candidates/delete",
        		 			type : "post",
