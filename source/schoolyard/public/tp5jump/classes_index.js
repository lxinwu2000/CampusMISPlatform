...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
    ...
    ,cols: [[
	  ...
	  ,{field:'gradename', width:100, title: '所属年级',align:'center'}
	  ,{field:'teachername', width:100, title: '班主任',align:'center'} 
  ...
  table.on('tool(Idtableb)', function(obj){
	   ...
	   if(obj.event === 'del'){
	      layer.confirm('真的删除这条数据么', function(index){	    		    	
	    	 Ajaxalls(rid,null,2,'admin/classes/delete');
//	    	 obj.del();
