...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
    ...
    ,cols: [[
      ...
      ,{field:'studentnumber', width:100, title: '学号',align:'center'}
      ,{field:'idcard', width:170, title: '身份证号',align:'center'}  
      ,{field:'classname', minWidth:100, title: '所属班级',align:'center'}  
  ...
  table.on('tool(Idtableb)', function(obj){
	   ...
	   if(obj.event === 'del'){
	      layer.confirm('真的删除这条数据么', function(index){	    		    	
	    	 Ajaxalls(rid,null,2,'admin/Students/delete');
//	    	 obj.del();
         ...
         ,getCheckid:function(){
        	 ...
        	 if(checkedid.length=='0'){
        		 ...
        		 layer.confirm('真的删除这些数据吗', function(index){       		    	
        		    	 $.ajax({
        		 			url : Root+"admin/Students/delete",
        		 			type : "post",
