...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
     elem: '#teachercontacttable'
    ,url:Root+'admin/Teachercontact/json'
    ,height: 'full-150'   
    ,cellMinWidth: 80 
    ...
    ,cols: [[
      ...
      ,{field:'wechat', width:100, title: '微信',align:'center'}
      ,{field:'alipay', width:100, title: '支付宝',align:'center'}
      ,{field:'address', width:197, title: '地址',align:'center'}        
  ...
  table.on('tool(Idtable)', function(obj){
	   ...
	   if(obj.event === 'del'){
	      layer.confirm('真的删除这条数据么', function(index){	    		    	
	    	 Ajaxalls(rid,null,2,'admin/Teachercontact/delete');
//	    	 obj.del();
	      });
	    } 
	 //编辑
         ...
         ,getCheckid:function(){
        	 ...
        	 if(checkedid.length=='0'){
        		 ...
        		 layer.confirm('真的删除这些数据吗', function(index){       		    	
        		    	 $.ajax({
        		 			url : Root+"admin/Teachercontact/delete",
        		 			type : "post",
