...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
    ...
    ,cols: [[
      ...
      ,{field:'studentname', width:100, title: '学生',align:'center'}
      ,{field:'coursename', width:100, title: '课程',align:'center'}
      ,{field:'score', width:180, title: '分数',align:'center'}
	  ,{field:'examdate', width:100, title: '考试日期',align:'center'}
  ...
  table.on('tool(Idtableb)', function(obj){
	   ...
	   if(obj.event === 'del'){
	      layer.confirm('真的删除这条数据么', function(index){	    		    	
	    	 Ajaxalls(rid,null,2,'admin/Scores/delete');
//	    	 obj.del();
