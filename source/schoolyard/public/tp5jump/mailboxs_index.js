...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
    ...
    ,cols: [[
      ...
      ,{field:'receivername', width:100, title: '收件人',align:'center'}
      ,{field:'sendername', width:100, title: '写信人名称',align:'center'} 
      ,{field:'senderaddress', width:180, title: '写信人地址',align:'center'}
	  ,{field:'senderphone', width:100, title: '写信人名称',align:'center'} 
      ,{field:'senderemail', width:180, title: '写信人地址',align:'center'} 
	  ,{field:'subject', width:100, title: '写信人名称',align:'center'} 
      ,{field:'message', width:180, title: '写信人地址',align:'center'}
      ,{field:'ispublic', width:180, title: '是否公开',align:'center'}
	  ,{field:'handleuserid', width:100, title: '办理用户',align:'center'} 
      ,{field:'handletime', width:180, title: '办理/处理时间',align:'center'}
      ,{field:'responsemessage', width:180, title: '反馈结果',align:'center'}
  ...
  table.on('tool(Idtableb)', function(obj){
	   ...
	   if(obj.event === 'del'){
	      layer.confirm('真的删除这条数据么', function(index){	    		    	
	    	 Ajaxalls(rid,null,2,'admin/Mailboxs/delete');
//	    	 obj.del();
         ...
         ,getCheckid:function(){
        	 ...
        	 if(checkedid.length=='0'){
        		 ...
        		 layer.confirm('真的删除这些数据吗', function(index){       		    	
        		    	 $.ajax({
        		 			url : Root+"admin/Mailboxs/delete",
        		 			type : "post",
